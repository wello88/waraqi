...
import { upload } from "../../utils/multer.cloud.js";
...
// add services
adminRouter.post('/add-service', isAuthenticated(), upload.single('document'), asyncHandler(addService))
// get all services
...
adminRouter.put('/update-service/:id', isAuthenticated(), isAuthorized(['admin']), upload.single('document'), asyncHandler(updateService));
